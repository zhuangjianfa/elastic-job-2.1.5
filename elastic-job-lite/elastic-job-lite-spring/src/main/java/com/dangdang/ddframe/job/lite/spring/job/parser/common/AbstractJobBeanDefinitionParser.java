...
public abstract class AbstractJobBeanDefinitionParser extends AbstractBeanDefinitionParser {
    ...
    private BeanDefinition createJobCoreBeanDefinition(final Element element) {
        ...
        jobCoreBeanDefinitionBuilder.addConstructorArgValue(element.getAttribute(BaseJobBeanDefinitionParserTag.JOB_EXECUTION_LOG));
        jobCoreBeanDefinitionBuilder.addConstructorArgValue(element.getAttribute(BaseJobBeanDefinitionParserTag.JOB_STATUS_TRACE_LOG));
