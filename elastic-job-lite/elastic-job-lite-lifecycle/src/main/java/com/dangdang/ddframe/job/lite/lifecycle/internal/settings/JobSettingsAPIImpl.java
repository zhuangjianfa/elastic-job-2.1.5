...
public final class JobSettingsAPIImpl implements JobSettingsAPI {
    ...
    private void buildSimpleJobSettings(final String jobName, final JobSettings result, final LiteJobConfiguration liteJobConfig) {
        ...
        result.setJobExecutionLog(liteJobConfig.getTypeConfig().getCoreConfig().isJobExecutionLog());
        result.setJobStatusTraceLog(liteJobConfig.getTypeConfig().getCoreConfig().isJobStatusTraceLog());
    }
    ...
    public void updateJobSettings(final JobSettings jobSettings) {
        ...
        LiteJobConfiguration result = LiteJobConfigurationGsonFactory.fromJson(regCenter.get(jobNodePath.getConfigNodePath()));
        jobSettings.setOverwrite(result.isOverwrite());
        jobSettings.setDisabled(result.isDisabled());
