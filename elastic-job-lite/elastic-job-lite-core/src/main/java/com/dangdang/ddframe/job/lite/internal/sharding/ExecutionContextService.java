...
public final class ExecutionContextService {
    ...
    public ShardingContexts getJobShardingContext(final List<Integer> shardingItems) {
        ...
        ShardingContexts context = null;
        if (shardingItems.isEmpty()) {
        	context = new ShardingContexts(
        	...
        	context =  new ShardingContexts(buildTaskId(liteJobConfig, shardingItems), liteJobConfig.getJobName(), liteJobConfig.getTypeConfig().getCoreConfig().getShardingTotalCount(), 
        ...
        context.setJobExecutionLog(liteJobConfig.getTypeConfig().getCoreConfig().isJobExecutionLog());
    	context.setJobStatusTraceLog(liteJobConfig.getTypeConfig().getCoreConfig().isJobStatusTraceLog());
    	return context;
    }
