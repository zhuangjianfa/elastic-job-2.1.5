...
public final class WwwAuthFilter implements Filter {
    ...
    public void init(final FilterConfig filterConfig) throws ServletException {
        rootUsername = StringUtils.isBlank(System.getenv("job-console.root.username")) ?  ROOT_DEFAULT_USERNAME : System.getenv("job-console.root.username");
        rootPassword = StringUtils.isBlank(System.getenv("job-console.root.password")) ? ROOT_DEFAULT_PASSWORD : System.getenv("job-console.root.password");
        guestUsername = StringUtils.isBlank(System.getenv("job-console.guest.username")) ? GUEST_DEFAULT_USERNAME : System.getenv("job-console.guest.username");
        guestPassword = StringUtils.isBlank(System.getenv("job-console.guest.password")) ? GUEST_DEFAULT_PASSWORD : System.getenv("job-console.guest.password");
    }
