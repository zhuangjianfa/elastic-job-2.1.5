...
public final class JobCoreConfiguration {
     ...
     * 扩展日志记录功能,数据库记录执行状态
     */
    private final  boolean jobExecutionLog;
    
    /**
     * 扩展日志记录功能,数据库记录执行轨迹
     */
    private final boolean jobStatusTraceLog;
    ...
    public static class Builder {
         ...
         * 扩展日志记录功能,数据库记录执行状态
         */
        private  boolean jobExecutionLog = true;
        
        /**
         * 扩展日志记录功能,数据库记录执行轨迹
         */
        private  boolean jobStatusTraceLog =false;
        ...
        /**
         * 扩展日志记录功能，JOB结果数据库记录执行状态
         */
        public Builder jobExecutionLog(final boolean jobExecutionLog) {
            this.jobExecutionLog = jobExecutionLog;
            return this;
        }
        
        /**
         * 扩展日志记录功能,JOB路由数据库记录执行状态
         */
        public Builder jobStatusTraceLog(final boolean jobStatusTraceLog) {
            this.jobStatusTraceLog = jobStatusTraceLog;
            return this;
        }
        ...
        public final JobCoreConfiguration build() {
            ...
            return new JobCoreConfiguration(jobName, cron, shardingTotalCount, shardingItemParameters, jobParameter, failover, misfire,jobExecutionLog,jobStatusTraceLog, description, jobProperties);
        }
    }
}
